<template>
    <div class="container2" id="form">
        ...
        <div class="comp-form-group2">
            ...
            <input type="number" name="celular" id="input2"  v-model="persona.celular" placeholder="ingrese el numero de celular ">
            </div>
            <div class="form-group">
            <label for="contacto">Contacto:</label>
            <input type="text" name="contacto" id="input2"  v-model="persona.contacto" placeholder="ingrese el nombre de contacto ">
            </div>
            <div class="form-group">
            <label for="celularAlt">Celular de contacto:</label>
            <input type="number" name="repeticiones" id="input2" v-model="persona.celularAlt" placeholder="ingrese el numero de celular alterno">
            </div>
            <div class="form-group">
