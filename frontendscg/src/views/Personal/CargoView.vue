<template>
    <div class="view">
        <div class="components">
            <FormCargo @escucharForm="puente" ref="componenteForm" @clearId="jumper"/>
            <TablaCargo ref="componente" @ById="read" @change="update" @escuchartable="tabla"/>
        </div>
    </div>
</template>
...
export default{
    ...
    methods:{
        puente(){
            this.$refs.componente.obtenerCargos();
        },
        read(value){
